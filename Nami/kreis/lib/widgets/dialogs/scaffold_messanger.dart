...
//         SnackBar(content:CustomText(title: title,fontColor: fontColor??white,fontSize:fontR14,),backgroundColor: bg??mainColor,));
//   }

//   static void showToast({required String title,Color? bg,Color? fontColor,ToastGravity gravity = ToastGravity.TOP}){
//     Fluttertoast.showToast(msg:title,backgroundColor: bg,textColor: fontColor,gravity: gravity);
//   }
// }