...
import 'package:kreis/presentation/home_screen/bottom_navigation_screens/home_screen/items_screen/single_item.dart/single_item.dart';
              ...
              child: Column(
                children: [
                  ...
                  FutureBuilder(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.connectionState == ConnectionState.done) {
                        List subCategories = snapshot.data!;
                        return Padding(
